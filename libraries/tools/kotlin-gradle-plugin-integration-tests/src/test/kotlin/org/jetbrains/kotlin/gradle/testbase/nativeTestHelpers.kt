...
fun TestProject.getFileCache(fileProjectName: String, fileRelativePath: String, fqName: String) =
    getFileCache("debugExecutable", "", fileProjectName, fileRelativePath, fqName)
...
fun TestProject.getFileCache(
    ...
    fqName: String,
) = getFileCache("debugExecutable", executableProjectName, fileProjectName, fileRelativePath, fqName)
