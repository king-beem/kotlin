...
fun main(args: Array<String>) {
    ...
    val generationPath = File(args[1])

    println("CRISTIAN: ${args[0]} - $generationPath")

    val packageName = "$basePackage.diagnostics"
    when(args[0]) {
        "checkers.jvm" -> generateDiagnostics(
            generationPath,
            "$packageName.jvm",
        ...
        "checkers.js" -> generateDiagnostics(
            generationPath,
            "$packageName.js",
            JS_DIAGNOSTICS_LIST,
            starImportsToAdd = setOf(
        ...
        "checkers.native" -> generateDiagnostics(
            generationPath,
            "$packageName.native",
        ...
        "checkers.wasm" -> generateDiagnostics(
            generationPath,
            "$packageName.wasm",
        ...
        "checkers.web.common" -> generateDiagnostics(
            generationPath,
        ...
        "raw-fir.common" -> generateDiagnostics(
            generationPath,
