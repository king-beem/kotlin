    ...
    private inner class AugmentedArraySetAsGetSetCallDesugaringInfo(
        ...
        fun toBlock(): FirBlock {
            return buildBlock {
                ...
                statements += setCall
                val sourceKind = when (augmentedArraySetCall.operation) {
                    ...
                    else -> error("Unexpected operator: ${augmentedArraySetCall.operation.name}")
                }
                source = augmentedArraySetCall.source?.fakeElement(sourceKind)
            }.also {
